...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = (0, _redux.createStore)(_root2.default, (0, _redux.applyMiddleware)(_reduxPromise2.default));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bookList = __webpack_require__(197);

	var _bookList2 = _interopRequireDefault(_bookList);

	var _bookDetails = __webpack_require__(200);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _bookListItem = __webpack_require__(198);
	  ...
	  _createClass(BookList, [{
	    ...
	    value: function render() {
	      var bookList = this.props.books.map(function (book) {
	        return _react2.default.createElement(_bookListItem2.default, { book: book, key: book.etag });
	      });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectBook = __webpack_require__(199);
	...
	var BookListItem = function (_React$Component) {
	  ...
	  function BookListItem() {
	    ...
	    return _possibleConstructorReturn(this, (BookListItem.__proto__ || Object.getPrototypeOf(BookListItem)).apply(this, arguments));
	  }

	  _createClass(BookListItem, [{
	    key: 'onClickBook',
	    value: function onClickBook(book) {
	    ...
	    value: function render() {
	      ...
	      var imgUrl = 'https://placeholdit.imgix.net/~text?txtsize=20&txt=Not%20Found&w=150&h=200';
	      if (book.volumeInfo.imageLinks) imgUrl = book.volumeInfo.imageLinks.smallThumbnail;
	...
	exports.default = (0, _reactRedux.connect)(null, mapDispatchToProps)(BookListItem);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BookDetails = function (_React$Component) {
	  ...
	  _createClass(BookDetails, [{
	    ...
	    value: function render() {
	      ...
	      if (!book) return _react2.default.createElement(
	        'h1',
	        null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getBooks = __webpack_require__(202);
	...
	var SearchBar = function (_React$Component) {
	  ...
	  function SearchBar(props) {
	    ...
	    _this.searchBooks = _this.searchBooks.bind(_this);
	    _this.state = { term: "" };
	    return _this;
	  }
	  ...
	  _createClass(SearchBar, [{
	    key: 'searchBooks',
	    value: function searchBooks(event) {
	...
	function mapDispatchToProps(dispatch) {
	  return (0, _redux.bindActionCreators)({ getBooks: _getBooks2.default }, dispatch);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reducerBookList = __webpack_require__(226);
